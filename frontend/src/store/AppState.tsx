...
const initialState: AppState = {
  companyInputs: {
    ...
    implemented_measures: {
      "Iluminación LED": "No",
      "GdO para energía eléctrica": "No",
      "Autoconsumo fotovoltaico / paneles solares": "No",
      "Flota de vehículos eléctricos": "No",
      "Variadores de frecuencia en motores": "No",
      "Sistema de gestión energética y submetering": "No",
      "Recuperación de calor residual": "No",
      "Control de fugas de gases refrigerantes": "No",
    },
